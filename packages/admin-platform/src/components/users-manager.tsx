...
import { extractErrorMessage, type ApiRequestFn } from "./api-client";

export interface UsersManagerMessages {
  common: {
    actions: string;
    apply: string;
    empty: string;
...
export function UsersManager({
  ...
  async function runAction(
    ...
    try {
      ...
      setMessage({
        kind: "error",
        text: extractErrorMessage(error, messages.common.connectionError),
      });
    } finally {
