...
import type { AdminPlatformDatabase } from "../db";
import { auditLogs, authTokens, rateLimits, sessions, users } from "../schema";
import { rateLimitTimestampParameters } from "./rate-limit-parameters";
...
> implements AuthRepository {
  constructor(private readonly database: AdminPlatformDatabase<TSchema>) {}
