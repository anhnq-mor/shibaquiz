...
/**
 * Matches the `locale` Postgres enum in `./schema.ts` (kept at vi/en to avoid
 * an unwanted migration in the app this was extracted from). A future
 * consumer needing a different locale set should fork both together.
 */
